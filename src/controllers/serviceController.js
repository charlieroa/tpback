...
// Obtener todos los servicios de un Tenant (con filtro por categoría) - VERSIÓN CORREGIDA
exports.getServicesByTenant = async (req, res) => {
    const { tenantId } = req.params;
    const { category_id } = req.query; // El nombre del parámetro es 'category_id'
    ...
    // LÓGICA DE FILTRADO
    if (category_id) {
        // Si el parámetro 'category_id' existe en la URL, se añade la condición a la consulta
...
// Obtener un servicio por su ID (sin cambios)
